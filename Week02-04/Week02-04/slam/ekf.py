...
class EKF:
    ...
    def predict(self, raw_drive_meas):
        ...
        # x_pred = F @ x
        #Update the state vector with the new prediction
    ...
    def add_landmarks(self, measurements):
        ...
        for lm in measurements:
            ...
            if np.allclose(self.robot.state[0:1], [0,0], atol=0.15):
                print("certain")
                uncertainty = 1
            else:
                print("uncertain")
                uncertainty = self.init_lm_cov

            self.P[-2,-2] = uncertainty**2
            self.P[-1,-1] = uncertainty**2 
